...
```env
REACT_APP_API_URL=https://styxcafe-revamp.preview.emergentagent.com/api
REACT_APP_ADMIN_URL=https://styxcafe-revamp.preview.emergentagent.com
...
### Admin Panel (.env)
```env
VITE_API_URL=https://styxcafe-revamp.preview.emergentagent.com/api
...
JWT_EXPIRY=7d
NODE_ENV=production
CLIENT_URL=https://styxcafe-revamp.preview.emergentagent.com
ADMIN_URL=https://styxcafe-revamp.preview.emergentagent.com
SMTP_EMAIL=
SMTP_PASSWORD=
...
3. **Test Endpoints**
   ```bash
   # Backend API
   curl https://styxcafe-revamp.preview.emergentagent.com/api/user/filterCafes -X POST -H "Content-Type: application/json" -d '{}'
   
   # Frontend
   curl https://styxcafe-revamp.preview.emergentagent.com
   ```
...
```
https://styxcafe-revamp.preview.emergentagent.com/        → Customer Website (Port 3001)
https://styxcafe-revamp.preview.emergentagent.com/admin   → Admin Panel (Port 3000)
https://styxcafe-revamp.preview.emergentagent.com/api     → Backend API (Port 8001)
```

**OR Multiple Subdomains:**
```
https://styxcafe-revamp.preview.emergentagent.com         → Customer Website
https://admin-styxcafe-revamp.preview.emergentagent.com   → Admin Panel
https://api-styxcafe-revamp.preview.emergentagent.com     → Backend API
```
...
- Visit: https://styxcafe-revamp.preview.emergentagent.com
...
### 3. Test Admin Panel
- Visit: https://styxcafe-revamp.preview.emergentagent.com/admin/login
- Login: styx.mumbai@example.com / admin123
- Verify: Dashboard loads with menu

### 4. Test Backend API
```bash
curl https://styxcafe-revamp.preview.emergentagent.com/api/user/filterCafes \
  -X POST \
...
**Production URLs:**
- Customer Website: https://styxcafe-revamp.preview.emergentagent.com
