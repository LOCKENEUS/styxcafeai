...
export const Manufacturer = ({ show, handleClose }) => {
    const lableHeader = {
        fontSize: "16px",
        fontWeight: "500",
    }
    ...
    return (
      ...
      <ModalBody>
        <Row className="my-0">
            <Col md={6}>
            <FormGroup>
                <label className="my-2 fw-bold" style={lableHeader}>Manufacturer name </label>
                <input type="text"  className="form-control" placeholder="Manufacturer name " style={inputStyle} />
            </FormGroup>
            </Col>
