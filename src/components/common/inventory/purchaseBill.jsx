...
export const PurchaseBill = () => {
    ...
    const itemsData = [
        { sn: 1, name: "5Item ", Status: " 100",  total: "ABC123", billNo: "1234567890" },
        { sn: 2, name: "1Item 22", Status: " 200",  total: "DEF456", billNo: "9876543210" },
        { sn: 3, name: "Item 3", Status: " 150",  total: "GHI789", billNo: "1122334455" },
    ];
