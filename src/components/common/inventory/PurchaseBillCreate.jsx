...
import { addPurchaseBill, getPurchaseBillById, updatePurchaseBill } from "../../../store/slices/Inventory/pbSlice";

export const PBCreate = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            if (id) {
                ...
                await dispatch(addPurchaseBill(submitData)).unwrap().then((res) => {
                    navigate(`/Inventory/PurchaseBillDetails/${res._id}`);
                });
            }
        } catch (error) {
    ...
    const handleCustomerSelect = (e) => {
        const selectedCafe = cafes.find(cafe => cafe._id === e.target.value);
                        ...
                        <div >
                            ...
                            <div className="d-flex flex-row mb-2 align-items-center gap-2">
                                ...
                                <Form.Check
                                    ...
                                    label="Cafe"
                                    value="cafe"
                                    checked={formData.delivery_type === "cafe"}
                                    onChange={(e) =>
                                        setFormData({ ...formData, delivery_type: e.target.value })
                                    }
                                    style={{ fontWeight: "bold", color: "black" }}
                                ...
                                <>
                                    ...
                                    <div className="my-3">
                                        {selectedCafe ? (
                                            ...
                                            <p className="text-muted mb-0">Select a cafe to view their details</p>
                                        )}
                                    </div>
                                </>
                            )}
