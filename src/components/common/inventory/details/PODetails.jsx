...
export const PODetails = () => {
    ...
    const handlePrint = () => {
        ...
        printWindow.document.write(`
            <html>
                <head>
                    <title>Purchase Order: ${selectedPo.po_no}</title>
            ...
            <Row data-aos="fade-up" data-aos-duration="500" className="mx-2">
                ...
                <Col sm={12} className="my-3">
                    <div style={{ top: "186px", fontSize: "14px" }}>
                        <Breadcrumb>
                            <BreadcrumbItem ><Link to="/Inventory/dashboard">Home</Link></BreadcrumbItem>
                            <BreadcrumbItem><Link to="/Inventory/PurchaseOrder">Purchase Order List</Link></BreadcrumbItem>
                ...
                {/* Company Info */}
                <Row id="printableArea" className="my-2 px-0 px-md-2">
                                            ...
                                            <tbody className="text-start" >
                                                {items.length > 0 && items.map((item, index) => (
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {item?.tax?.tax_name ? `${item.tax.tax_name} : ${item.tax.tax_rate}%` : "No Tax"}
                                                        </td>
                                    ...
                                    <Table className="text-end">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>&#8377; {selectedPo?.total.toFixed(2)}</td>
                                            </tr>
