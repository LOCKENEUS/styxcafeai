...
import { createSaPurchaseOrder } from "../../../store/slices/Inventory/poSlice";
...
export const PurchaseOrderCreate = () => {
    ...
    const TaxList = useSelector((state) => state.tax?.taxes);
    ...
    const updateProduct = (id, field, value) => {
        const updatedProducts = products.map((product) => {
            if (product.id === id) {
                ...
                if (field === "tax") {
                    const selectedTax = TaxList.find(tax => tax._id === value);
