...
import { getSalesReturnList } from '../../../../store/slices/Inventory/returnSlice';
...
export const SalesReturnList = () => {
  ...
  const handleShowCreate = () => {
    navigate("/Inventory/SalesReturn");
  };
  ...
  const itemsData = Array.isArray(salesReturnList)
        ...
        <Col sm={12} className="mx-2 my-3">
          <div style={{ top: "186px", fontSize: "12px" }}>
            <Breadcrumb>
              ...
              <BreadcrumbItem active>Sales Return List</BreadcrumbItem>
            </Breadcrumb>
          </div>
        </Col>
              ...
              <Col sm={3} className="d-flex my-2">
                <InputGroup className="navbar-input-group">
                  ...
                  <FormControl
                    type="search"
                    size="sm"
                    placeholder="Search for package shipping"
