...
import { addSaVendor, getSaVendorById, updateSaVendor } from "../../../store/slices/Inventory/saVendorSlice";
...
export const VendorCreate = () => {
    ...
    const handleSubmit = (e) => {
        ...
        formDataToSend.append('userType', "superadmin");
        ...
        if (id) {
            dispatch(updateSaVendor({ id, vendorData: formDataToSend }))
                .unwrap()
                .then(() => {
            ...
            dispatch(addSaVendor(formDataToSend))
                .unwrap()
                .then(() => {
                    // Navigate to vendor list on success
                    navigate(-1);
