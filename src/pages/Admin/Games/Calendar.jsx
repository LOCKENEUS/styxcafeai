...
const Calendar = ({ openClientModal }) => {
  ...
  return (
    <div className="calendar-slider mt-5">
      ...
      {activeDate.getDay() === 0 ? (
        ...
        <BookingSlots date={activeDate} openClientModal={ openClientModal }/>
      )}
    </div>
  );
};

const BookingSlots = ({ date, openClientModal }) => {
          ...
          <div className="d-flex flex-column flex-md-row justify-content-between align-items-center">
            ...
            <div className="d-flex flex-column flex-md-row align-items-center gap-3">
              ...
              <Button
                ...
                // onClick={
                //   () => handleBookSlot(gameId, slot.id, date)
                //   // alert(`Booked ${slot.time} on ${date.toDateString()}`)
                // }
