...
export const InvoiceCreate =()=>{
    const [selectedDate, setSelectedDate] = useState("");
        ...
        <div style={{ top: "186px", fontSize: "18px" }}>
            <Breadcrumb>
                ...
                <BreadcrumbItem> <Link to="/admin/Inventory/SalesOrder">Invoice List</Link></BreadcrumbItem>
                <BreadcrumbItem active>Invoice Create</BreadcrumbItem>
            </Breadcrumb>
            </div>
        </Col>
                ...
                <FormControl
                  ...
                  <div className="d-flex flex-column gap-2">
                    <div  className=" d-flex flex-row align-items-center gap-2">
                      <FormControl style={{  border:"1px solid black", height:"44px" , borderStyle:"dashed"}} placeholder="Payment Terms" />
    ...
    <Card className="p-3  shadow-sm">
              ...
              <Row className="border-bottom border-top border-3 ">

              <Button 
                  variant="outline-primary" 
                  className="my-4 w-100 w-sm-50 w-md-25" 
  ...
  <div
    ...
    style={{ minHeight: "200px", border: "1px solid black", borderStyle: "dashed", cursor: "pointer" }}
  ...
  <FormControl
    ...
    onChange={(e) => console.log("Selected File:", e.target.files[0])} // Handle file selection
  />
</Col>


                <Col sm={12} className="d-flex justify-content-end align-items-end my-3">
