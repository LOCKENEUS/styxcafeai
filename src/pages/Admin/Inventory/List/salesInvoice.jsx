...
export const SaleInvoiceInventory = () => {
   ...
   >
             ...
             <div>
               <div style={{ color: "#0062FF",cursor:"pointer"}} onClick={handalDetails}>{row.name}</div>
       ...
       { name: " Date", selector: (row) => row.shipmentDate, sortable: true },
     ...
     const handalDetails = () => {
       navigator("/admin/Inventory/SaleInvoiceDetails");
     };
