  ...
  const scenes = [
    {
      ...
      shapes: [
        { size: 500, x: '15%', y: '30%', color: 'rgba(0, 212, 255, 0.25)' },
        { size: 450, x: '75%', y: '60%', color: 'rgba(184, 41, 255, 0.25)' },
      ]
    },
    {
      name: 'Neon Pink',
      ...
      shapes: [
        { size: 450, x: '60%', y: '40%', color: 'rgba(255, 41, 212, 0.25)' },
        { size: 500, x: '25%', y: '70%', color: 'rgba(0, 255, 136, 0.25)' },
      ]
    },
    {
      name: 'Golden Glow',
