...
import { getPurchaseBillById } from "../../../../store/slices/Inventory/pbSlice";
...
export const PurchaseBillDetails = () => {
    ...
    useEffect(() => {
        if (id) {
            dispatch(getPurchaseBillById(id));
        }
    }, [dispatch, id]);
                    ...
                    <Card className="p-3">
                        <Row>
                            ...
                            <Col sm={6} xs={12} className="d-flex flex-wrap justify-content-center justify-content-sm-end align-items-center gap-2 text-center">
                                ...
                                <Button
                                    onClick={() =>
                                        navigate(`/Inventory/PurchaseBillCreate/${selectedBill._id}`)
                                    }
                                    className="d-flex align-items-center"
                                    style={{
                                ...
                                <Col sm={8}>
                                    <Row>
                                        ...
                                        <Col sm={6}>
                                            ...
                                            <div className="my-5 mx-2 border-start border-3 p-2 d-flex flex-column gap-3">
                                                <div><span className="my-1 fw-bold">Expected Delivery:</span> {new Date(selectedBill.delivery_date).toLocaleDateString()}</div>
                                                <div><span className="my-1 fw-bold">Payment Terms:</span> {selectedBill.payment_terms}</div>
                                                <div><span className="my-1 fw-bold">Reference:</span> {selectedBill.reference}</div>
                                                <div><span className="my-1 fw-bold">Shipment Preference:</span> {selectedBill.shipment_preference}</div>
                                            </div>
                                        </Col>
                                    </Row>
                                </Col>
