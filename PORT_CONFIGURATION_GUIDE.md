...
### Preview URL Mapping
**https://sporty-booking.preview.emergentagent.com/** → Port 3000 (Sporty Frontend)
...
The preview URL (`https://sporty-booking.preview.emergentagent.com/`) is configured to route traffic to **port 3000** by default. By moving the Sporty frontend to port 3000, the preview URL now correctly displays the new Sporty application instead of the old Styx website.
...
### Access URLs
- Sporty: http://localhost:3000 or https://sporty-booking.preview.emergentagent.com/
